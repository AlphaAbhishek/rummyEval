...
public class EvaluatorUtility {
	...
	public boolean isASet(String s) {
		// I will send you a String of above characters and x-es. You have to
		// check for validity. Ex of valid set - 22x,222x,4xx3
		return false;
	}

	@SuppressWarnings("static-access")
	public String getModifiedString(RummyHand r, Card joker) {
		// should give a string of sorted cards according to Suit. Separate
		// Suits by space.
